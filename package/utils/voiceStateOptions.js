module.exports = {
  ...
  guildName:
    "The name of the guild this voice state update happened in.;guild.name.deleteBrackets()",
  name:
    "The name of the user that updated its voice state.;.member.user.username.deleteBrackets()",
  id: "The ID of the user that updated its voice state.;.id",
  channelID:
    "The ID of the voice channel this voice state update occurred in.;.channelID || ''",
  channelName:
    "The name of the voice channel this voice state update occurred in.;.channel.name.deleteBrackets() || ''",
  serverDeaf:
    "Whether the user is server deafened.;.serverDeaf ? `true` : `false`",
