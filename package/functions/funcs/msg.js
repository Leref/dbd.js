...
module.exports = async (d) => {
  ...
  if (!channel)
    return d.error(`:x: Invalid channel ID in 1st field of \`$msg${inside}\`.`);
  ...
  if (!result)
    return d.error(`:x: Missing option in 3rd field of \`$msg${inside}\`.`);
  if (
    ![
      "author",
      "authormention",
    ...
    return d.error(`:x: Invalid option in 3rd field of \`$msg${inside}\`.`);
  ...
  try {
    ...
    switch (result) {
      case "author":
        ...
        break;
      case "authormention":
        result = message.author.toString(messageID);
        break;
      case "authorname":
        result = message.author.username;
        break;
      case "authortag":
        result = message.author.tag;
        break;
      case "channelid":
      ...
      case "channelname":
        ...
        break;
      case "channelmention":
        result = message.channel.toString(channel);
        break;
      case "nomentioncontent":
      ...
      case "content":
        ...
        break;
      case "created":
        result = moment(message.createdAt).format("LLLL");
        break;
      case "guildid":
      ...
      case "ispinned":
        ...
        break;
      case "cleancontent":
        result = message.cleanContent.split("@").join("");
        break;
      case "guildname":
